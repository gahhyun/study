       		...
       		<div id="line-2">
       			...
       			<div class="Rcontent" >
           			<div class="maintext">
           				...
           				<div class="pro-dan">
               				<div>
               					<a href="#" onclick="javascript:goProfile(${articleDTO.user_no},'${articleDTO.user_nicknm }')"><img class="profile" src="${articleDTO.image }" alt="profile" ></a>
                 				<a href="#" onclick="javascript:goProfile(${articleDTO.user_no},'${articleDTO.user_nicknm }')" class="nickname" >${articleDTO.user_nicknm }</a>
               				</div>
						...
						<c:choose>
							<c:when test="${not empty sessionScope.user_no}">
								<li class="comment_write" id="commentCard">
				                	...
				                	<a class="nickname" href="#">${user_nicknm}</a>
				                	<div>
			...
			function fnCreateCommentList(response){
				...
				if(list.length > 0){
					...
					list.forEach(function(v ,i){
						...
						createHtml +=				'<a href="javascript:goProfile('+v.user_no +',\''+v.cmt_writer+'\')"><img class="profile" src="'+v.image+'" alt="profile" ></a>';
						createHtml +=				'<a href="javascript:goProfile('+v.user_no +',\''+v.cmt_writer+'\')" class="nickname" >'+v.cmt_writer+'</a>';
