...
<body style="background-color: #202020;">
	...
	$(document).ready(function() {
        ...
        //<%= ... %>는 서버 사이드 템플릿에서 값의 동적인 삽입을 나타냅니다.이 부분은 서버에서 계산된 값을 클라이언트(브라우저)로 전달하는 역할
		//서버에서 전달된 "pwdMsg" 매개변수의 값을 클라이언트(브라우저)의 JavaScript 변수 pwdMsg에 할당하는 역할을 합니다
		//이렇게 함으로써 서버 측에서 클라이언트 측으로 데이터를 전달할 수 있습니다.
	...
	function kakaoInit(){
    	...
    	Kakao.init('your javascript key');	//본인의 JavaScript 키 입력
        Kakao.isInitialized();
	}
